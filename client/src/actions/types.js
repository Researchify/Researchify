...
export const DELETE_BATCH_TEAM_MEMBERS = 'DELETE_BATCH_TEAM_MEMBERS';
...
export const RESET_ACHIEVEMENT = 'RESET_ACHIEVEMENT';
export const DELETE_BATCH_ACHIEVEMENTS = 'DELETE_BATCH_ACHIEVEMENTS';
