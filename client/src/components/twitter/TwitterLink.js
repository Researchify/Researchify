        ...
        <Jumbotron className="twitter-link">
            <h6 className="twitter-link_link_message">Link your Twitter account?</h6>
            {
                ...
                <Form>
                    <Form.Row>
                        <Col>
                            <Form.Control className="twitter-link_input" size="sm" placeholder="Enter handle"
                                          value={handle}
            ...
            <Button type="submit" size="sm" className="twitter-link_button" onClick={handleLinkButtonClick}>Link
                Twitter</Button>
            {
                revealInput &&
